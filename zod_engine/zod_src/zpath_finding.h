...
public:
	...
	int Find_Path(int sx, int sy, int ex, int ey, bool is_robot, int obj_ref_id );
	bool Direct_Path_Possible(int sx, int sy, int ex, int ey, bool is_robot);
	
	void SetImpassable(int x, int y, bool impassable = true);
	bool WithinImpassable(int x, int y, int w, int h, bool is_robot);
