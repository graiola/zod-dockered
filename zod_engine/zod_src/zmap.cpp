...
// 		planet_tile_info_new[i][j].is_starter_tile = false;
// 	}
// 	fwrite(planet_tile_info_new[palette], sizeof(palette_tile_info_new), MAX_PLANET_TILES, fp);
...
bool ZMap::PermStamp(int x_, int y_, ZSDL_Surface *surface)
{
	SDL_Rect to_rect;
...
bool ZMap::PermStamp(int x_, int y_, SDL_Surface *surface)
{
	SDL_Rect to_rect;
